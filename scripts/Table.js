...
function clearRecordForm() {
  $('#datExamDate').val("");
  $('#SystolicBloodPressure').val("");
  $('#DiastolicBloodPressure').val("");
  return true;
}
...
function listRecords() {
  ...
  if (tbRecords != null) {
    ...
    $("#tblRecords").html(
      ...
      "   <tr>" +
      "     <th>Date</th>" +
      "     <th><abbr title='Systolic'>SBP</abbr></th>" +
      "     <th><abbr title='Diastolic'>DBP</abbr></th>" +
      "     <th>Edit / Delete</th>" +
      "   </tr>" +
      "</thead>" +
      "<tbody>" +
...
function showRecordForm(index) {
  try {
    ...
    $('#SystolicBloodPressure').val(rec.Systolic);
    $('#DiastolicBloodPressure').val(rec.Tg);
  } catch (e) {
    /* Google browsers use different error 
     * constant
     */
...
function addRecord() {
  if (checkRecordForm()) {
    var record = {
      ...
      "Systolic": $('#SystolicBloodPressure').val(),
      "Diastolic": $('#DiastolicBloodPressure').val(),
    };
